    ...
    if (o.value == "") {
      if (o.type == "password") {
        if (!r.data("placeholder-textinput")) {
          ...
          s.removeAttr("name").data({"placeholder-password": r, "placeholder-id": q}).on("focus.placeholder", c);
...
!(function (c) {
  ...
  c.fn[g] = function (N, E) {
    ...
    if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(N)) {
      ...
      if (typeof N == "object" || !N) {
        var F = c.extend({checkedClass: s, disabledClass: i, indeterminateClass: b, labelHover: true}, N), G = F.handle,
          I = F.hoverClass || "hover", M = F.focusClass || "focus", K = F.activeClass || "active", C = !!F.labelHover,
          H = F.labelHoverClass || "hover", D = ("" + F.increaseArea).replace("%", "") | 0;
        if (G == q || G == a) {
          J = 'input[type="' + G + '"]'
        }
        if (D < -50) {
  ...
  function v(B, H, G) {
    var C = B[0], E = /er/.test(G) ? b : /bl/.test(G) ? i : s,
      F = G == r ? {checked: C[s], disabled: C[i], indeterminate: B.attr(b) == "true" || B.attr(h) == "false"} : C[E];
...
(function (e) {
  ...
  c.prototype.init = function () {
    ...
    if (f.btnTip) {
      this.$picker.attr("data-toggle", "tooltip").tooltip({title: f.btnTip, placement: f.tooltip, container: "body"})
    }
...
!function (d) {
  ...
  c.prototype.getCalculatedOffset = function (e, h, f, g) {
    return e == "bottom" ? {top: h.top + h.height, left: h.left + h.width / 2 - f / 2} : e == "top" ? {
      top: h.top - g,
    ...
    constructor: i, _events: [], _attachEvents: function () {
      ...
      if (o.length == 1) {
        ...
        switch (o[0].nodeName.toLowerCase()) {
          ...
          case"span":
            if (!o.is(".disabled")) {
              var q = this.viewDate.getUTCFullYear(), p = this.viewDate.getUTCMonth(), r = this.viewDate.getUTCDate(),
                s = this.viewDate.getUTCHours(), l = this.viewDate.getUTCMinutes(), t = this.viewDate.getUTCSeconds();
              if (o.is(".month")) {
          ...
          case"td":
            if (o.is(".day") && !o.is(".disabled")) {
              ...
              var q = this.viewDate.getUTCFullYear(), p = this.viewDate.getUTCMonth(), s = this.viewDate.getUTCHours(),
            ...
            if (q.closest(".has-switch").is(".deactivate")) {
              ...
              q.on("mousemove touchmove", function (x) {
                var s = a(this).closest(".switch"),
                  u = (x.pageX || x.originalEvent.targetTouches[0].pageX) - s.offset().left, v = (u / s.width()) * 100,
                  w = 25, t = 75;
                d = true;
                if (v < w) {
                  v = w
